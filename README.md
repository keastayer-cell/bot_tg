...
- `/admin` - Проверить, является ли пользователь админом
...
Очередь работает по принципу FIFO (первый вошёл - первый вышел). Элементы отправляются в порядке добавления.
